function [results, model] = pde_cubeiter_inhomogeneous_test(results,cube,reduce,iter,interp_fineness,mesh_fineness,varargin)
...
%     end
    ...
    applyBoundaryCondition(model,'dirichlet','face',names(1),'u',1);%fbnd1);
    applyBoundaryCondition(model,'dirichlet','face',names(2),'u',1);%,fbnd2);
    applyBoundaryCondition(model,'dirichlet','face',names(3),'u',0);%,fbnd3);
    applyBoundaryCondition(model,'dirichlet','face',names(4),'u',0);%,fbnd4);
    applyBoundaryCondition(model,'dirichlet','face',names(5),'u',0);%,fbnd5);
    applyBoundaryCondition(model,'dirichlet','face',names(6),'u',0);%,fbnd6);
