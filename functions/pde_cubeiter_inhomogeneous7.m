function [model, result_struct] = pde_cubeiter_inhomogeneous7(stlname,result,mypdeoptions,varargin)
...
dataname = IsExistSolution2(stlname,mypdeoptions);
...
if savedata
    dataname = SavePdeResults2(model,result,stlname,mypdeoptions);
end
